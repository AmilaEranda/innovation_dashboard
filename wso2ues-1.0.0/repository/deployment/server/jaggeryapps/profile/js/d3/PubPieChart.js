function PubPieChart(area, data, options) {
    var cnfg = {
        marginTop: 20,
        marginRight: 20,
        marginBottom: 20,
    ...
    this.globalPieNum = globalPubPieNumber++;

    $("body").append('<div id="pub-pie-tooltip' + this.globalPieNum + '" class="pub-pie-tooltip"></div>');
    $("#pub-pie-tooltip" + this.globalPieNum).css({"position": "absolute", "background": "rgba(0, 0, 0, 0.8)", "color": "white", "font-family": "Arial", "font-size": "14px", "font-weight": "lighter", "z-index": "100", "pointer-events": "none"});
    $("#pub-pie-tooltip" + this.globalPieNum).append('<div id="pub-pie-tooltip-content' + this.globalPieNum + '" style="padding: 5px 10px 5px 10px;">');
    $("#pub-pie-tooltip-content" + this.globalPieNum).append('<span id="pub-pie-tooltip-desc' + this.globalPieNum + '" style="font-size: 12px;">desc of tooltip</span><br/>');
    $("#pub-pie-tooltip-content" + this.globalPieNum).append('<span id="pub-pie-tooltip-value' + this.globalPieNum + '" style="font-size: 16px;">value of tooltip</span>');

    $("#pub-pie-tooltip" + this.globalPieNum).hide();
    ...
    this.draw = function() {
		...
		$("#pub-pie-tooltip" + parseInt(pieNum)).hide();
        ...
        arcGroup.selectAll("path")
                .on("mouseover", function(d) {
                    ...
                    d3.select("#pub-pie-tooltip-desc" + pieNum).text(d.data.name);
                    d3.select("#pub-pie-tooltip-value" + pieNum).text(d.data.value);
                    d3.select("#pub-pie-tooltip" + pieNum)
                            .transition()
                            .style("display", "block")
                ...
                .on("click", function(d, i) {
					if (d.data.type == "aoi") {
						fetchPubsCountData("saoi", d.data.id, d.data.name);
					} else if (d.data.type == "saoi"){
						fetchPubsCountData("ssaoi", d.data.id, d.data.name);
					} 
                });
