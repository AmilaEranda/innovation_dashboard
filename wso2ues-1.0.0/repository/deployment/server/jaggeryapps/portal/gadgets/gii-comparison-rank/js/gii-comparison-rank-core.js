...
function fetchCountriesPiData() {
	var url =  "../../portal/gadgets/gii-comparison-rank/data-files/countries-pi-data.jag";
	$.ajax({
		url: url,
		type: "GET",
		dataType: "json",
...
function fetchCustomData() {
	...
	var url = "../../portal/gadgets/gii-comparison-rank/data-files/gii-comparison-rank-data.jag";
...
function setInfoForCharts(){
	...
	if (pillarType === "gv") { // global values
		$("#info-icon").tooltip({
			...
			placement: "left",
			html: true,
			title: '<div style="text-align: left; font-size: 11px;"><p><i class="fa fa-info-circle fa-lg"></i>&nbsp; <b>Ranks</b> in Global Innovation Index</p><p>Select a country to compare ranks with Sri Lanka</p><p>Change global values to pillars in the drop-down menu in order to compare pillar ranks with Sri Lanka</p></div>'
		});
		...
		$("#info-icon").tooltip({
			...
			placement: "left",
			html: true,
			title: '<div style="text-align: left; font-size: 11px;"><p><i class="fa fa-info-circle fa-lg"></i>&nbsp; <b>Ranks</b> of the pillars in Global Innovation Index</p><p>Select a country to compare ranks with Sri Lanka</p></div>'
		});
	}
}
